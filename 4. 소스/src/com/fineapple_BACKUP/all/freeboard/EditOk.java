...
public class EditOk extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) 
		...
		try {	//첨부파일 위한 try catch
			...
			fbdto.setSeq(multi.getParameter("seq"));
			...
			int result = service.edit(fbdto);
			
			
			//결과 잘 들어갔는지 저장 + 시퀀스
			req.setAttribute("result", result);
			req.setAttribute("seq", fbdto.getSeq());
	
			RequestDispatcher dispatcher = req.getRequestDispatcher("/company/pages/all/freeboard/editok.jsp");
