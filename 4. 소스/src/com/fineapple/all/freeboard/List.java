...
public class List extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) 
		...
		ArrayList<VFreeBoardDTO> list = new ArrayList<VFreeBoardDTO>(); //게시물 리스트
		
		list = service.getList(map);	//리스트 얻어오기
		...
		RequestDispatcher dispatcher = req.getRequestDispatcher("/company/pages/all/freeboard/list.jsp");
