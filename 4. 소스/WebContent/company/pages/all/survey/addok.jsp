            ...
            <c:if test="${result == 1}">
	            <div class="confirmBox">
	            	...
	            	<div class="btns">
	            		...
	            		<input type="button" value="설문조사 보기" class="btn btn-info" onclick="location.href='/Project/all/survey/view.do?seq=${seq}';">
	            	</div>
	            </div>
            </c:if>
            ...
            <c:if test="${result == 0}">
	            <div class="confirmBox">
	            	<div class="end">
	            		...
	            		<div style="font-weight: bold;">설문조사가 등록되지 않았습니다.</div>
