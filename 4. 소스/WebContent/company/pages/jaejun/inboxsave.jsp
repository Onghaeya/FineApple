        ...
        <div id="page-wrapper">
            <div class="row">
                <div id="headerInbox" class="col-lg-12">
                    <h1 class="page-header">쪽지보관함 <span style="font-size: 0.5em">총 쪽지 개수: ${plist.size()}개</span></h1>
                <!-- /.col-lg-12 -->
	            </div>
            </div>
            <!-- /.row -->
            ...
            <div class="row" style="position: relative;">
            	<div style="position: absolute; top: -60px; left: 730px;">
            		<select name="MsgboxSel" id="MsgboxSel" style="height: 30px;">
						...
						<option value="3" selected="selected">쪽지보관함</option>
            		</select>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
	                <div style="color: #2F73C0; margin-bottom: 10px;">* 보관함에 저장된 쪽지는 자동삭제되지 않습니다.</div> 
	                <table width="100%" id="table" class="table table-striped table-bordered table-hover" id="dataTables-example">
	                    ...
	                    <tbody>
	                        ...
	                        <tr class="odd">
	                            ...
	                            <td><a href="/Project/message/view.do?sseq=${dto.sseq}&rseq=${dto.rseq}&boardnum=3" style="font-size: 1.2em">${dto.title}</a></td>
