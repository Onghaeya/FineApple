            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" method="post" action="/Project/company/pages/login/loginok.jsp">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="사번을 입력하세요" name="seq" autofocus>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="비밀번호를 입력하세요" name="pw" type="password" value="">
                                </div>
                                <div class="checkbox">
                                    <label>
                                ...
                                <input type="submit" class="btn btn-lg btn-success btn-block" value="로그인" style="width:48%; display:inline;"></input>
                                 <input	onclick="location.href='/Project/company/pages/login/login/register.jsp';"
													class="btn btn-lg btn-success btn-block" value="직원등록"
