...
<script>
	$(document).ready(function(){
		...
		$("#revote").click(function(){
			$(this).remove();
			$(".v-btn").prepend("<input type='submit' id='votego' name='votego' value='투표하기' class='btn btn-primary'>");	
			$(".v-detail").css("display","block");
			$(".second").attr("class","v-detail");
		});
	}); 
			...
			<div class="container-fluid">
				...
				<div class="wrap">
					...
					<div class="v-body row">
						...
						<div class="v-content">
							<div class="v-detail" style="display:none"><button type="button" class="btn btn-default btn-circle btn-lg" title="unchecked" value="${item.seq}"></button></div>
							<div class="second">	
					...
					<!-- vbodyrow -->
					<form action="/Project/club/voteeditok.do" method="post">
					<div class="v-btn" class="row">
						
						<input type="button" id="revote" name="revote"
							value="다시투표하기" class="btn btn-primary">
						...
						<input type="hidden" name="prechecked" id="prechecked" value="${voteseq}">
					</div>
					</form>
				</div>
