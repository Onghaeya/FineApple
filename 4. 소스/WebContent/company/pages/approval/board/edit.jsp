        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <!-- 글쓰기 폼 -->
                    <!-- 파일 안쓸거면 enc.... 지우기 -->
                    <form method="POST" action="/Project/approval/board/editok.do">
               			<table id="tbl" class="table table-striped">
				<tr>
					<th>이름</th>
					<td><input type="text" name="name" value="${dto.name}" id="name" class="form-control short" required></td>
					
				</tr>
				<tr>
					<th>제목</th>
					<td><input type="text" name="subject" id="subject" value="${dto.subject}" class="form-control long" required></td>
				</tr>
				<tr>
					<th>내용</th>
					<td><textarea name="content" id="content" class="form-control long" required>${dto.content}</textarea></td>
				</tr>
				<tr>
					<th>암호</th>
