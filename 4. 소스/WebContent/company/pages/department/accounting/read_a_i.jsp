				...
				<div class="col-lg-12">
					<div class="panel panel-primary">
						<div class="panel-heading">
							<i class="fa fa-bar-chart-o fa-fw"></i> 매출 및 수입보고 처리
						</div>
						<!-- /.panel-heading -->
						<div class="panel-body">
							<form class="form-submit" action="/Project/company/pages/department/read_a_go.do" method="post">
								<table id="read" width="100%" class="table table-striped table-bordered table-hover">
									<tr class="table-read">
										<th colspan="4">내용확인 및 수입처리</th>
									</tr>
									<tr class="table-read">
										<th style="width:10%">작성자</th>
										<td style="width:35%">${idto.empName}</td>
										<th style="width:10%">해당부서</th>
										<td style="width:35%">${idto.department}</td>
									</tr>
									<tr class="table-read">
										<th>분류</th>
										<td>${idto.cSeq}</td>
									...
									<tr class="table-read">
										...
										<td>${idto.goods}</td>
										<th>주석</th>
										<td><textarea name="goods" id="goods" rows="5" class="form-control" style="resize:none;"></textarea></td>
									</tr>
									<tr class="table-read">
										<th>수량</th>
										<td>
											<div class="form-group input-group">
												<input type="text" class="form-control" value="${idto.units}" style="text-align:right" readonly>
									...
									<tr class="table-read">
										...
										<td>
											<div class="form-group input-group">
												<input type="text" class="form-control" value="${idto.amount}" style="text-align:right" readonly>
									...
									<tr class="table-read">
										...
										<td>
											...
											<span class="input-group-addon">+</span>
												<input type="text" name="amount" id="amount" class="form-control" value="${idto.amount * idto.units}" style="text-align:right" readonly>
												<span class="input-group-addon">원</span>
											</div>
										</td>
										<th>처리 후 잔고</th>
							...
							<div id="btns" class="col-sm-12">
								...
								<input type="hidden" id="seq" name="seq" value="${idto.seq}" />
							...
							<input name="result${dto.seq}" id="result${dto.seq}" value="${(dto.balance) + (idto.amount * idto.units)}" style="display:none;" />
							</c:forEach>
						</div>
						<!-- /.panel-body -->
					</div>
