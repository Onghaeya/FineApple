        ...
        <div id="page-wrapper">
            ...
            <c:if test="${result == 1}">
	            <div class="confirmBox">
	            	<div class="end">
	            		<img src="/Project/company/images/Pchecked.jpg" >
	            		
	            		<div style="margin-bottom: 3px;"></div>
	            		<div style="font-weight: bold;">수정이 완료되었습니다!</div> 
	            		
	            	</div>
	            	<div class="btns">
	            		<input type="button" value="목록으로" class="btn btn-primary" onclick="location.href='/Project/company/pages/position/scheduleMain.do'">
	            		<input type="button" value="글보기" class="btn btn-info" onclick="location.href='/Project/company/pages/position/sview2.do?seq=${seq}';">
	            	</div>
	            </div>
            </c:if>
            ...
            <c:if test="${result == 0}">
	            <div class="confirmBox">
	            	<div class="end">
	            		...
	            		<img src="/Project/company/images/Palertnot.jpg">
	            		<div></div>
	            		<div style="font-weight: bold;">글이 수정되지 않았습니다.</div>
